...
public class CharacterNetworkManager : NetworkBehaviour
{
    ...
    //A server rpc is a function called from a client, to the server (In our case the hose)
    [ServerRpc]
    ...
    {
        // We make sure not to run the function on the character who went it (so we dont play the animation twice)
    ...
    private void PerformActionAnimationFromServer(string animationID, bool applyRootMotion)
    {
        ...
        Debug.Log($"[Server] Trying to play animation: {animationID}");
        ...
        float contactPointZ)
    {
        if (IsServer)
        {
            NotifyTheServerOfCharacterDamageClientRpc(damagedCharacterID, characterCausingDamageID, physicalDamage, magicalDamage, fireDamage, lightningDamage, holyDamage, poiseDamage, angleHitFrom, contactPointX, contactPointY, contactPointZ);
        }
    }
    ...
    float contactPointZ)
    {
        ProcessCharacterDamageFromServer(damagedCharacterID,characterCausingDamageID, physicalDamage, magicalDamage, fireDamage, lightningDamage, holyDamage, poiseDamage, angleHitFrom, contactPointX, contactPointY, contactPointZ); 
    }
