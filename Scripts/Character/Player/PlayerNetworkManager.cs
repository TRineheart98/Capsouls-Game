...
public class PlayerNetworkManager : CharacterNetworkManager
{
    ...
    public void OnCurrentQuickSlotIDChange(int oldID, int newID)
    {
        ...
        if (newQuickSlotItem != null)
        {
            ...
            if (player.IsOwner)
                PlayerUIManager.instance.playerUIHudManager.SetQuickSlotItemSlotIcon(newID);
        }
    }
    ...
    {
        //We notify the server we have performed the action, so we perform it from their perspective aswell
